...
- Enforce mandatory code review processes
- Maintain comprehensive documentation

### Git Workflow
- Use feature branches for development
- All code changes must be submitted through pull requests with descriptive titles and detailed descriptions
...
- Reviewers must verify compliance with existing project specifications (including Zod validation, rate limiting policies, and security requirements)
- Mandatory review process for all code changes, with special emphasis on security-related modifications
- Required review criteria:
  - Code quality
  - Security compliance
  - Performance considerations
  - Adherence to architectural patterns
- Specific requirements for reviewing rate limiting implementations:
  - Verification of proper middleware ordering
  - Error response formats compliance
  - IP-based limiting with forwarded header support
- Clear guidelines for reviewers to validate that new dependencies have been properly vetted for security vulnerabilities
- Process for handling critical security fixes that may require expedited review while maintaining security standards
